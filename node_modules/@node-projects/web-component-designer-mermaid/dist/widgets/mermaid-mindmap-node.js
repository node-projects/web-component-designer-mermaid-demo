...
var MermaidMindmapNodeShape;
(function (MermaidMindmapNodeShape) {
    MermaidMindmapNodeShape["default"] = "default";
    MermaidMindmapNodeShape["square"] = "square";
    MermaidMindmapNodeShape["round"] = "round";
    MermaidMindmapNodeShape["circle"] = "circle";
    MermaidMindmapNodeShape["bang"] = "bang";
    MermaidMindmapNodeShape["cloud"] = "cloud";
    MermaidMindmapNodeShape["hexagon"] = "hexagon";
})(MermaidMindmapNodeShape || (MermaidMindmapNodeShape = {}));
export class MermaidMindmapNode extends BaseCustomWebComponentConstructorAppend {
    ...
    * {
    ...
    `;
    static template = html `<svg id="connections"></svg><div id="node"></div><slot id="children"></slot>`;
    static is = "mermaid-mindmap-node";
    mindmapId = "Root";
    label = "Node";
    ...
    _connections;
    _slot;
    _childObserver = new MutationObserver(() => this._renderConnections());
    _resizeObserver = new ResizeObserver(() => this._renderConnections());
    static properties = {
        mindmapId: String,
        label: String,
    ...
    constructor() {
        ...
        this._node = this._getDomElement("node");
        this._connections = this._getDomElement("connections");
        this._slot = this._getDomElement("children");
    }
    async ready() {
    ...
    _render() {
        ...
        const shape = this.getAttribute("shape") ?? this.shape;
    ...
    _getMindmapChildren() {
        return this._slot.assignedElements().filter((element) => element.localName === MermaidMindmapNode.is);
    }
    createMermaid() {
...
function getConnectionStrokeWidth(element) {
    let depth = 0;
