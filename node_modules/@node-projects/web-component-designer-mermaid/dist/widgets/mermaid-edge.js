...
var MermaidEdgeType;
(function (MermaidEdgeType) {
    MermaidEdgeType["arrow"] = "arrow";
    MermaidEdgeType["open"] = "open";
    MermaidEdgeType["dotted"] = "dotted";
    MermaidEdgeType["thick"] = "thick";
    MermaidEdgeType["invisible"] = "invisible";
    MermaidEdgeType["circle"] = "circle";
    MermaidEdgeType["cross"] = "cross";
    MermaidEdgeType["multi"] = "multi";
})(MermaidEdgeType || (MermaidEdgeType = {}));
export class MermaidEdge extends BaseCustomWebComponentConstructorAppend {
    ...
    * {
    ...
    static is = "mermaid-edge";
    from = "A";
    to = "B";
    label = "";
    edgeType = MermaidEdgeType.arrow;
    connector = "-->";
    edgeId = "";
    animation = "";
    waypoints = "";
    ...
    constructor() {
        ...
        this._label = this._getDomElement("label");
        this._path = this._getDomElement("path");
    ...
    _render() {
        ...
        const edgeType = this.getAttribute("edge-type") ?? this.edgeType;
    ...
    createMermaid() {
        ...
        const connector = explicitConnector ? { plain: explicitConnector, label: explicitConnector } : getConnector(this.getAttribute("edge-type") ?? this.edgeType);
...
function getMarkerEnd(edgeType, connector) {
...
function getConnector(edgeType) {
    switch (edgeType) {
